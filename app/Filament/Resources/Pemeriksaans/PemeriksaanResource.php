...
use App\Filament\Resources\Pemeriksaans\Pages\ViewPemeriksaan;
use App\Filament\Resources\Pemeriksaans\Schemas\PemeriksaanForm;
use App\Filament\Resources\Pemeriksaans\Schemas\PemeriksaanInfolist;
...
class PemeriksaanResource extends Resource
{
    ...
    {
        return PemeriksaanInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewPemeriksaan::route('/{record}'),
